...
Exam Buddy is a local Python + Tkinter desktop study app.
...
To enable OpenAI generation, set `OPENAI_API_KEY`, optionally set `OPENAI_MODEL`, then tick `Use AI` in the app.
